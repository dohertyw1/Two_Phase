...
# with open('/media/wdoherty1/Samsung_T5/mass_frac//media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=6.5//media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=6.5_data.csv', newline='') as csvfile: #70
#     datanr1601 = np.array(list(csv.reader(csvfile, delimiter='\t')))

# with open('/media/wdoherty1/Samsung_T5/mass_frac//media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=13//media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=6.5_data.csv', newline='') as csvfile: #70
#     datanr1602 = np.array(list(csv.reader(csvfile, delimiter='\t')))

# with open('/media/wdoherty1/Samsung_T5/mass_frac//media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=26//media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=6.5_data.csv', newline='') as csvfile: #70
...
with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=6.5_T0.13/frames/frame_0.13/phi_read_0.13.xdmf') as infile:
    infile.read_checkpoint(phi_65, "phi")
with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=6.5_T0.13/frames/frame_0.13/u_read_0.13.xdmf') as infile:
    infile.read_checkpoint(u_65, "u")
with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=6.5_T0.13/frames/frame_0.13/tau_read_0.13.xdmf') as infile:
    infile.read_checkpoint(tau_65, "tau")

phi_13 = Function(V)
u_13=Function(Vvec)
tau_13 = Function(Vten)
with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=13_T0.13/frames/frame_0.13/phi_read_0.13.xdmf') as infile:
    infile.read_checkpoint(phi_13, "phi")
with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=13_T0.13/frames/frame_0.13/u_read_0.13.xdmf') as infile:
    infile.read_checkpoint(u_13, "u")
with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=13_T0.13/frames/frame_0.13/tau_read_0.13.xdmf') as infile:
    infile.read_checkpoint(tau_13, "tau")

phi_26 = Function(V)
u_26=Function(Vvec)
tau_26 = Function(Vten)
with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=26_T0.13/frames/frame_0.13/phi_read_0.13.xdmf') as infile:
    infile.read_checkpoint(phi_26, "phi")
with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=26_T0.13/frames/frame_0.13/u_read_0.13.xdmf') as infile:
    infile.read_checkpoint(u_26, "u")
with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=26_T0.13/frames/frame_0.13/tau_read_0.13.xdmf') as infile:
    infile.read_checkpoint(tau_26, "tau")

# u_65_wake = Function(Vvec)
# u_26_wake = Function(Vvec)
# with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=6.5/frames/frame_0.201/u_read_0.201.xdmf') as infile:
#     infile.read_checkpoint(u_65_wake, "u")
# with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=26/frames/frame_0.201/u_read_0.201.xdmf') as infile:
...
# V = FunctionSpace(mesh, 'CG', 2)
# phi300 = Function(V)
# with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=26/phi_read.xdmf') as infile:
...
# u200 = Function(Vu)
# with XDMFFile('/media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=6.5/u_read.xdmf') as infile:
#     infile.read_checkpoint(u200, "u")

# mesh = RectangleMesh(Point(0,0),Point(2,4),200,400,'crossed')
# V = FunctionSpace(mesh, 'CG', 2)
# phi300 = Function(V)
# with XDMFFile('/media/wdoherty1/Samsung_T5/mass_frac//media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=13/phi_read.xdmf') as infile:
#     infile.read_checkpoint(phi300, "phi")

# mesh = RectangleMesh(Point(0,0),Point(2,4),200,400,'crossed')
# V = FunctionSpace(mesh, 'CG', 2)
# phi400 = Function(V)
# with XDMFFile('/media/wdoherty1/Samsung_T5/mass_frac//media/wdoherty1/Samsung_T5/data_for_paper/Cons_Viscoelastic_CG_Dim_c=26/phi_read.xdmf') as infile:
#     infile.read_checkpoint(phi400, "phi")
...
plt.colorbar(plot(sqrt(u_65**2), cmap='jet',vmin=a1,vmax=a2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
plt.colorbar(plot(tau_65[0,0], cmap='jet',vmin=b1,vmax=b2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
plt.colorbar(plot(tau_65[1,0], cmap='jet',vmin=c1,vmax=c2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
cbar = plt.colorbar(plot(tau_65[1,1], cmap='jet',vmin=d1,vmax=d2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
plt.colorbar(plot(sqrt(u_13**2), cmap='jet',vmin=a1,vmax=a2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
plt.colorbar(plot(tau_13[0,0], cmap='jet',vmin=b1,vmax=b2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
plot(phi_13, levels=[0.5], linewidths=3,mode='contour', colors = 'black')
plt.colorbar(plot(tau_13[1,0], cmap='jet',vmin=c1,vmax=c2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
plot(phi_13, levels=[0.5], linewidths=3,mode='contour', colors = 'white')
cbar = plt.colorbar(plot(tau_13[1,1], cmap='jet',vmin=d1,vmax=d2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
plt.colorbar(plot(sqrt(u_26**2), cmap='jet',vmin=a1,vmax=a2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
plt.colorbar(plot(tau_26[0,0], cmap='jet',vmin=b1,vmax=b2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
plt.colorbar(plot(tau_26[1,0], cmap='jet',vmin=c1,vmax=c2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
...
cbar = plt.colorbar(plot(tau_26[1,1], cmap='jet',vmin=d1,vmax=d2),fraction=0.09, pad=0.04)
plt.xlim([0.5,1.5])
plt.ylim([0.75,2.75])
