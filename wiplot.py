...
with open('wetau/Cons_Viscoelastic_CG_NonDim_w4/Cons_Viscoelastic_CG_NonDim_w4_data.csv', newline='') as csvfile: #70
    datanr1601 = np.array(list(csv.reader(csvfile, delimiter='\t')))

with open('wetau/Cons_Viscoelastic_CG_NonDim_w8/Cons_Viscoelastic_CG_NonDim_w8_data.csv', newline='') as csvfile: #70
    datanr1602 = np.array(list(csv.reader(csvfile, delimiter='\t')))

with open('wetau/Cons_Viscoelastic_CG_NonDim_w16/Cons_Viscoelastic_CG_NonDim_w16_data.csv', newline='') as csvfile: #70
    datanr1603 = np.array(list(csv.reader(csvfile, delimiter='\t')))

with open('wetau/Cons_Viscoelastic_CG_NonDim_w32/Cons_Viscoelastic_CG_NonDim_w32_data.csv', newline='') as csvfile: #70
...
with XDMFFile('wetau/Cons_Viscoelastic_CG_NonDim_w4/frames/frame_12.1244/phi_read_12.1244.xdmf') as infile:
    infile.read_checkpoint(phi_651, "phi")
with XDMFFile('wetau/Cons_Viscoelastic_CG_NonDim_w8/frames/frame_12.1244/phi_read_12.1244.xdmf') as infile:
    infile.read_checkpoint(phi_652, "phi")
with XDMFFile('wetau/Cons_Viscoelastic_CG_NonDim_w16/frames/frame_12.1244/phi_read_12.1244.xdmf') as infile:
    infile.read_checkpoint(phi_653, "phi")
with XDMFFile('wetau/Cons_Viscoelastic_CG_NonDim_w32/frames/frame_12.1244/phi_read_12.1244.xdmf') as infile:
    infile.read_checkpoint(phi_654, "phi")
...
ax1.legend([r'$\textrm{Wi} = 4$',r'$\textrm{Wi} = 8$',r'$\textrm{Wi} = 16$',r'$\textrm{Wi} = 32$'],loc='upper left',frameon=True,prop={'size': 12})
...
ax5.legend([r'$\textrm{Wi} = 4$',r'$\textrm{Wi} = 8$',r'$\textrm{Wi} = 16$',r'$\textrm{Wi} = 32$'],loc='upper right',frameon=True,prop={'size': 12})
...
axc.legend([r'$\textrm{Wi} = 4$',r'$\textrm{Wi} = 8$',r'$\textrm{Wi} = 16$',r'$\textrm{Wi} = 32$'],loc='lower left',frameon=True,prop={'size': 12})
...
# plot(phi_654, levels=[0.5], linewidths=3,mode='contour', colors = '#d62728')

plt.plot([1],[4],color='#1f77b4')
plt.plot([1],[5],color='#ff7f0e')
plt.plot([1],[6],color='#2ca02c')
# plt.plot([1],[7],color='#2ca02c')
...
ax1.yaxis.set_tick_params(which='major', size=5, width=2, direction='in', right='on')
ax1.tick_params(axis='both', which='major', labelsize=13)
ax1.legend([r'$\textrm{Wi} = 4$',r'$\textrm{Wi} = 8$',r'$\textrm{Wi} = 16$',r'$\textrm{Wi} = 32$'],loc='lower left',frameon=True,prop={'size': 15})
