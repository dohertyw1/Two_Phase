...
if (rank == 0 and os.path.isfile(f'droplet_ve40/data.csv') == True):

    os.remove('droplet_ve40/data.csv')
...
file_phi = XDMFFile('droplet_ve40/phidim.xdmf')
file_u = XDMFFile('droplet_ve40/udim.xdmf')
file_p = XDMFFile('droplet_ve40/pdim.xdmf')
file_tau = XDMFFile('droplet_ve40/taudim.xdmf')
...
for n in tqdm(range(num_steps)):
    ...
    if rank == 0:
        with open((f"droplet_ve40/data.csv"), 'a') as csvfile:
